                                                                ...
                                                                <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;width:100%;">
                                                                    <div align="center" style="line-height:10px">
                                                                        <a href="javascript:;" style="outline:none" tabindex="-1">
                                                                            <img alt="Logo" src="{!!$siteHeaderLogo!!}" style="display: block;height: auto;border: 0;width: 200px;max-width: 100%;background-color: #232323;padding: 15px;" title="Logo" width="150"/>
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
