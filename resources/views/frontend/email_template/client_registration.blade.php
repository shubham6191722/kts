                                ...
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0;background-color: #FFF;border: 1px solid #e2e2e2;" width="600">
                                            <tbody>
                                                <tr>
                                                    <th class="column" style="mso-table-lspace: 0; mso-table-rspace: 0; font-weight: 400; text-align: left; vertical-align: top; padding: 25px;" width="100%">
                                                        ...
                                                        @else
                                                            <table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0; word-break: break-word;" width="100%">
                                                                <tr>
                                                                    <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;width:100%;background: #f2f2f2;">
                                                                        <div align="center" style="line-height:10px">
                                                                            <a href="javascript:;" style="outline:none" tabindex="-1">
                                                                                <img alt="Logo" src="{!!$siteHeaderLogo!!}" style="display: block;height: auto;border: 0;width: 200px;max-width: 100%;padding: 15px;" title="Logo" width="150"/>
                                                                            </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
