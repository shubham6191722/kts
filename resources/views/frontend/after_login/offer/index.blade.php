                                                ...
                                                <div class="card-body pt-4 d-flex flex-column">
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        @if($p_value->offer_status == 0)
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center my-1">
                                                                <button class="btn btn-light-success font-weight-bolder font-size-sm mt-2 offer-accept-btn" data-offer-id="{{$p_value->id}}" data-user-id="{{$p_value->candidate_id}}" data-value="1">Accept</button>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form class="form" method="POST" action="{{ route('candidate.offerDeclin')}}">
                                                                                    @csrf
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                    ...
                                                    <div class="card-body pt-4 d-flex flex-column">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            @if($a_value->offer_status == 0)
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center my-1">
                                                                    <button class="btn btn-light-success font-weight-bolder font-size-sm mt-2 offer-accept-btn" data-offer-id="{{$a_value->id}}" data-user-id="{{$a_value->candidate_id}}" data-value="1">Accept</button>
                                                                    <button class="btn btn-light-danger font-weight-bolder font-size-sm mt-2  offer-declin-btn" data-theme="dark" data-html="true" data-toggle="modal" data-target="#offer_declin">Decline</button>
                                                                    <div class="modal fade" id="offer_declin" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                                            <div class="modal-content">
                                                    ...
                                                    <div class="card-body pt-4 d-flex flex-column">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            @if($d_value->offer_status == 0)
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center my-1">
                                                                    <button class="btn btn-light-success font-weight-bolder font-size-sm mt-2 offer-accept-btn" data-offer-id="{{$d_value->id}}" data-user-id="{{$d_value->candidate_id}}" data-value="1">Accept</button>
                                                                    <button class="btn btn-light-danger font-weight-bolder font-size-sm mt-2  offer-declin-btn" data-theme="dark" data-html="true" data-toggle="modal" data-target="#offer_declin">Decline</button>
                                                                    <div class="modal fade" id="offer_declin" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                                            <div class="modal-content">
            ...
            $('body').on('click', '.offer-accept-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{route('candidate.offerAccept')}}",
                            type: 'POST',
                            data: {
                                "value": value,
                                "_token": token,
