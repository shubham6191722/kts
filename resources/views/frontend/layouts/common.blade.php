                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group register_select register_select_2">
                                        <label>Work preference <small class="text-lowercase">(you can select multiple option.)</small></label>
                                        <div class="input-with-icon line-height-0">
                                            @php
                                ...
                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                    <div class="form-group register_select register_select_2">
                                        <label>Skill <small class="text-lowercase">(you can select multiple option.)</small></label>
                                        <div class="input-with-icon line-height-0">
