                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{route('rats-5768.clientAdd')}}" class="btn btn-primary font-weight-bolder mr-2">
                                    ...
                                    <table class="table dt-table-hover" id="zero-config" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>@if(isset($value['company_credits']) && !empty($value['company_credits'])){!! $value['company_credits'] !!}@endif</td>
                                                <td>
                                                ...
                                                <td nowrap="nowrap">
                                                    ...
                                                    <a href="javascript:;" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2 client-copy-link" data-link="{{route('home.getClientJobDetail',['id' => $client_slug])}}" data-toggle="tooltip" data-theme="dark" data-html="true" title="Link"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                            <i class="fas fa-link"></i>
                                                        </span> 
                                                    </a>

                                                    <a href="{{route('rats-5768.clientEdit',['id' => $value['id']])}}" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-toggle="tooltip" data-theme="dark" data-html="true" title="Edit"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                    ...
                                                    <a href="{{route('rats-5768.membershipEdit',['id' => $value['id']])}}" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-toggle="tooltip" data-theme="dark" data-html="true" title="Membership Edit"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                    ...
                                                    @php
                                                        ...
                                                        $sub_company_data = App\Models\SubCompany::getSubCompany($client_id);
                                                        if(isset($sub_company_data) && !empty($sub_company_data) && count($sub_company_data)){
                                                            $check_sub_company = true;
                                                        }
                                                    @endphp
                                                    {{-- @if($check_sub_company) --}}
                                                        <a href="{{route('rats-5768.editSubCompany',['id' => $value['id']])}}" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-toggle="tooltip" data-theme="dark" data-html="true" title="Add Sub Company"> 
                                                            <span class="svg-icon svg-icon-md"> 
                                                    ...
                                                    <form action="{{ route('rats-5768.clientDelete')}}" method="post" >
