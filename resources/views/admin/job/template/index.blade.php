                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Templates List
                            </h3>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <table class="table dt-table-hover" id="zero-config" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>@if(isset($value['template_name']) && !empty($value['template_name'])){!! $value['template_name'] !!}@endif</td>
                                                <td nowrap="nowrap">

                                                    <a href="javascript:void(0)" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-theme="dark" data-html="true" title="Edit" data-toggle="modal" data-target="#skillEdit_{{$key}}"> 
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form" method="POST" action="{{ route($route_name.'.templateUpdate')}}">
                                                                        @csrf
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="text" class="form-control form-control-lg  mb-2" name="template_name" value="@if(isset($value['template_name']) && !empty($value['template_name'])){!! $value['template_name'] !!}@endif" placeholder="Template Name" required />
                                                    ...
                                                    <form action="{{ route($route_name.'.templateDelete')}}" method="post" >
                                                        <input type="hidden" name="id" value="{!!$value['id']!!}" />
                                                        @csrf
                                                    </form>
                                                </td>
