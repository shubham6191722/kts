            ...
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <div class="show active tab-pane px-7" id="kt_tab_my_account_setting" role="tabpanel">
                        <form class="form" method="POST" action="{{ route($route_name.'.jobAlertCreate')}}">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    @endphp
                                                    <input type="text" class="form-control form-control-lg mb-2" name="site_favicon" value="{!! old('site_favicon',$site_favicon) !!}" placeholder="Email Subject" />
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <textarea type="text" class="form-control form-control-lg mb-2 summernote" name="site_notification_email" placeholder="Email Description">{!! old('site_notification_email',$site_notification_email) !!}</textarea>
                                                </div>
