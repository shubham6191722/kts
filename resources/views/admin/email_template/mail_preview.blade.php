                    ...
                    <td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th class="column" style="mso-table-lspace: 0; mso-table-rspace: 0; font-weight: 400; text-align: left; vertical-align: top;" width="100%">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0;mso-table-rspace: 0;word-break: break-word;background: #f2f2f2;" width="100%">
                                                            <tr>
                                                                <td style="padding-bottom: 20px;padding-left:10px;padding-right:10px;padding-top:20px;width:100%;background-color: #f2f2f2;">
                                                                    <div align="center" style="line-height:10px">
                                                                        <a href="javascript:;" style="outline:none" tabindex="-1">
                                                                            <img alt="Logo" src="{!!$data['company_logo']!!}" style="display: block;height: auto;border: 0;width: 200px;max-width: 100%;padding: 15px;" title="Logo" width="150"/>
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td style="padding: 25px;" >
                                                                    <div style="font-family: sans-serif">
                                                                        <div style="font-size: 14px; color: #000; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                            ...
                                                                            @php
                                                                                $emailDescription = \App\CustomFunction\CustomFunction::decode_input($data['emailDescription']);
                                                                            @endphp
                                                                ...
                                                                <td style="padding: 25px;" >
                                                                    <div style="font-family: sans-serif">
                                                                        <div style="font-size:14px;color:#000;line-height:1.2;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;text-align: center;">
                                                                            <a href="{!! $data['link'] !!}" style="color: #ffffff;background-color: #000000;transition: color 0.15s ease, background-color 0.15s ease, border-color 0.15s ease, box-shadow 0.15s ease, -webkit-box-shadow 0.15s ease;padding: 10px 35px;font-size: 15px;border-radius: 5px;text-decoration: none;">Sign In</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0;padding-bottom: 32px;" width="100%">
                            <tbody>
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0;background-color: #ffffff;" width="600">
                                            <tbody>
                                                <tr>
                                                    <th class="column" style="mso-table-lspace: 0; mso-table-rspace: 0; font-weight: 400; text-align: left; vertical-align: top; padding-left: 10px; padding-right: 10px;" width="100%">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0;" width="100%">
                                                            <tr>
                                                                <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;width:100%;">
                                                                    <div align="center" style="line-height:10px">
                                                                        <a href="javascript:;" style="outline:none" tabindex="-1">
                                                                            <img alt="Logo" src="{!!$data['siteHeaderLogo']!!}" style="display: block;height: auto;border: 0;width: 50px;max-width: 100%;" title="Logo" width="100"/>
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0; word-break: break-word;" width="100%">
                                                            <tr>
                                                                <td style="padding-bottom:0px;padding-left:10px;padding-right:10px;padding-top:10px;padding-bottom: 20px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div style="font-size: 14px; color: #000; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                            <p style="margin: 0; text-align: center; font-size: 12px;"><span style="font-size:12px;color: #000000;">Copyright &copy; {!!date('Y')!!} {!!$data['siteTitle']!!}.</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
