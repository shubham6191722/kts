                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Edit Mail Template</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form class="form" id="kt_form_2" method="POST" action="{{ route($route_name.'.emailTemplateUpdate')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="template_title" value="@if(isset($mail_template->template_title) && !empty($mail_template->template_title)){!! $mail_template->template_title !!}@endif" placeholder="Template Title" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="email_subject" value="@if(isset($mail_template->email_subject) && !empty($mail_template->email_subject)){!! $mail_template->email_subject !!}@endif" placeholder="Email Subject" required />
                                                    </div>
                                                                ...
                                                                <select class="form-control select2" name="sub_company" id="sub_company">
                                                                    <option selected value=""></option>
                                                                        @foreach($sub_company as $s_CKey => $sub_data_value)
                                                                            <option value="{!! $sub_data_value->id !!}" @if($mail_template->sub_company == $sub_data_value->id) selected @endif>{!! $sub_data_value->company_name !!}</option>
                                                                        @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <textarea type="text" class="form-control form-control-lg mb-2 summernote" name="email_description" placeholder="Email Description" required>@if(isset($mail_template->email_description) && !empty($mail_template->email_description)){!! $mail_template->email_description !!}@endif</textarea>
                                                    </div>
                                                </div>
