...
@section('content')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Work flow List</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="javascript:void(0)" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#workflowAdd">
                                    ...
                                    <table class="table dt-table-hover" id="zero-config" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>@if(isset($value['workflow_name']) && !empty($value['workflow_name'])){!! $value['workflow_name'] !!}@endif</td>
                                                <td nowrap="nowrap">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form" method="POST" action="{{route('client.jobWorkFlowUpdate')}}">
                                                                        @csrf
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>Name</label>
                                                                                    <div>
                                                                                        <input type="text" class="form-control form-control-lg  mb-2" name="name" value="@if(isset($value['workflow_name']) && !empty($value['workflow_name'])){!! $value['workflow_name'] !!}@endif" placeholder="Skill Name" />
                                                    ...
                                                    <a href="{{route('client.jobWorkFlowStage',['id' => $value['id']])}}" class="btn btn-sm btn-light btn-hover-warning btn-icon" data-toggle="tooltip" data-theme="dark" data-html="true" title="Add Stage" data-id="{!!$value['id']!!}"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                            <i class="icon-1x text-dark-50 flaticon2-medical-records"></i>
                                                        </span> 
                                                    </a>
    ...
    <div class="modal fade" id="workflowAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{route('client.jobWorkFlowAdd')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
