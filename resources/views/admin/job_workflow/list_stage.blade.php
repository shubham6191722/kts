...
@section('content')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Stage List</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="{{route('client.jobWorkFlowList')}}" class="btn btn-primary font-weight-bolder mr-1">
                                <span class="svg-icon svg-icon-primary svg-icon-2x">
                                    <i class="icon-1x text-white flaticon2-left-arrow-1"></i>
                                </span>
                                Back To WorkFlow
                            </a>
                            <a href="javascript:void(0)" class="btn btn-primary font-weight-bolder " data-toggle="modal" data-target="#statusAdd">
                                    ...
                                    <table class="table dt-table-hover" id="zero-config" role="grid" aria-describedby="kt_datatable_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>@if(isset($value['stage_name']) && !empty($value['stage_name'])){!! $value['stage_name'] !!}@endif</td>
                                                <td>@if(isset($value['order']) && !empty($value['order'])){!! $value['order'] !!}@endif</td>

                                                <td nowrap="nowrap">
                                                    <a href="javascript:void(0)" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-theme="dark" data-html="true" title="Edit" data-toggle="modal" data-target="#statusEdit_{{$key}}"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form" method="POST" action="{{route('client.jobWorkFlowStageUpdate')}}">
                                                                        @csrf
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>Name</label>
                                                                                    <div>
                                                                                        <input type="text" class="form-control form-control-lg  mb-2" name="name" value="@if(isset($value['stage_name']) && !empty($value['stage_name'])){!! $value['stage_name'] !!}@endif" placeholder="Skill Name" />
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>Order</label>
                                                                                    <div>
                                                                                        <input type="number" class="form-control form-control-lg mb-2" name="order" value="@if(isset($value['order']) && !empty($value['order'])){!! $value['order'] !!}@endif" placeholder="Order" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <form action="{{route('client.jobWorkFlowStageDelete')}}" method="post" >
    ...
    <div class="modal fade" id="statusAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{route('client.jobWorkFlowStageCreate')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Name</label>
                                    <div>
                                        <input type="text" class="form-control form-control-lg mb-2" name="name" value="{!! old('name') !!}" placeholder="Name" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Order</label>
                                    <div>
                                        <input type="number" class="form-control form-control-lg mb-2" name="order" value="{!! $count !!}" placeholder="Order" />
