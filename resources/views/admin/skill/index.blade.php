...
@section('content')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <a href="javascript:void(0)" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#skillAdd">
                                            ...
                                            @if(!empty($skillList))
                                                @foreach($skillList as $key => $value)
                                                    <tr class="odd">
                                                        ...
                                                        <td>@if(isset($value['c_id']) && !empty($value['c_id'])){!! App\Models\JobCategory::categoryName($value['c_id']) !!}@endif</td>
                                                        <td>@if(isset($value['skill_name']) && !empty($value['skill_name'])){!! $value['skill_name'] !!}@endif</td>
                                                        <td nowrap="nowrap">
                                                            <a href="javascript:void(0)" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2 skill-edit" data-theme="dark" data-html="true" title="Edit" data-toggle="modal" data-target="#skillEdit_{{$key}}"> 
                                                                <span class="svg-icon svg-icon-md"> 
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect x="0" y="0" width="24" height="24"></rect>
                                                            ...
                                                            <div class="modal fade" id="skillEdit_{{$key}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form class="form" method="POST" action="{{route('rats-5768.skillUpdate')}}">
                                                                                @csrf
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <select class="form-control select2" name="c_id" required>
                                                                                                    @if(!empty($job_category))
                                                                                                        @foreach($job_category as $job_categoryKey => $job_category_value)
                                                                                                            <option value="{!! $job_category_value->category_id !!}" @if($value['c_id'] == $job_category_value->category_id) selected @endif >{!! $job_category_value->category !!}</option>
                                                                                                        @endforeach
                                                                                                    @endif
                                                                                                </select>
                                                                                            </div>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input type="text" class="form-control form-control-lg  mb-2" name="skill_name" value="@if(isset($value['skill_name']) && !empty($value['skill_name'])){!! $value['skill_name'] !!}@endif" placeholder="Skill Name" />
                                                            ...
                                                            <form action="{{ route('rats-5768.skillDelete')}}" method="post" >
    ...
    <div class="modal fade" id="skillAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{route('rats-5768.skillCreate')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select class="form-control select2" name="c_id" required>
                                            ...
                                            @if(!empty($job_category))
                                                @foreach($job_category as $job_categoryKey => $job_category_value)
                                                    @if (old('c_id') == $job_category_value->category_id)
                                                        <option value="{!! $job_category_value->category_id !!}"selected>{!! $job_category_value->category !!}</option>
                                                    @else
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Skill Name</label>
                                    <div>
                                        <input type="text" class="form-control form-control-lg mb-2" name="skill_name" value="{!! old('skill_name') !!}" placeholder="Skill Name" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('footerScripts')
    ...
    <script>
        ...
        $('body').on('click', '.skill-edit', function() {
            KTSelect2.init();
        });
    </script>
@stop