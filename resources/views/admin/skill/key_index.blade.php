                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Key Word List</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table dt-table-hover" id="zero-config" role="grid"
                                        ...
                                        <tbody>
                                            @if(!empty($jobKeyWordList))
                                                @foreach($jobKeyWordList as $key => $value)
                                                    <tr class="odd">
                                                        <td class="dtr-control" tabindex="{!!$key+1!!}">{!!$key+1!!}</td>
                                                        <td>@if(isset($value['keyword_name']) && !empty($value['keyword_name'])){!! $value['keyword_name'] !!}@endif</td>

                                                        <td nowrap="nowrap">
                                                            <a href="javascript:void(0)" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-theme="dark" data-html="true" title="Edit" data-toggle="modal" data-target="#keyEdit_{{$key}}"> 
                                                                <span class="svg-icon svg-icon-md"> 
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect x="0" y="0" width="24" height="24"></rect>
                                                            ...
                                                            <div class="modal fade" id="keyEdit_{{$key}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form class="form" method="POST" action="{{route('rats-5768.keyWordUpdate')}}">
                                                                                @csrf
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input type="text" class="form-control form-control-lg  mb-2" name="keyword_name" value="@if(isset($value['keyword_name']) && !empty($value['keyword_name'])){!! $value['keyword_name'] !!}@endif" placeholder="KeyWord Name" />
                                                            ...
                                                            <form action="{{ route('rats-5768.keyWordDelete')}}" method="post" >
    ...
    <div class="modal fade" id="skillAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{route('rats-5768.keyWordCreate')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>KeyWord Name</label>
                                    <div>
                                        <input type="text" class="form-control form-control-lg mb-2" name="keyword_name" value="{!! old('keyword_name') !!}" placeholder="KeyWord Name" />
                                    </div>
                                </div>
                            </div>
                        </div>
