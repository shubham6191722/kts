                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{route('client.staffAdd')}}" class="btn btn-primary font-weight-bolder">
                                            ...
                                            @if(!empty($staffList))
                                                @foreach($staffList as $key => $value)
                                                    <tr class="odd">
                                                        ...
                                                        <td>@if(isset($value['department']) && !empty($value['department'])){!! $value['department'] !!}@endif</td>
                                                        <td>
                                                        ...
                                                        <td nowrap="nowrap">
                                                            <a href="{{route('client.staffEdit',['id' => $value['id']])}}" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-toggle="tooltip" data-theme="dark" data-html="true" title="Edit"> 
                                                                <span class="svg-icon svg-icon-md"> 
                                                            ...
                                                            <form action="{{ route('client.staffDelete')}}" method="post" >
