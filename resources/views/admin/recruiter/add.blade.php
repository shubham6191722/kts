                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form class="form" id="kt_form_2" method="POST" action="{{ route('rats-5768.recruiterCreate')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Company</label>
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="company_name" value="{!! old('company_name') !!}" placeholder="Company Name" required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="job_title" value="{!! old('job_title') !!}" placeholder="Job Title" required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="recruitment_specialism" value="{!! old('recruitment_specialism') !!}" placeholder="Recruitment specialism" required />
                                                    </div>
                                                </div>
                                            </div>
...
@section('footerScripts')
    ...
    <script>
        ...
        $('#kt_select2').on('change', function(){
            validator.revalidateField('locatedregion');
        });
    </script>
@stop
