...
@section('title', 'Advertisement option')
...
@section('content')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Advertisement option</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="javascript:void(0)" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#advertisementAdd">
                                ...
                                </span>Add Advertisement option</a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <table class="table dt-table-hover" id="zero-config" role="grid"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>@if(isset($value['option_name']) && !empty($value['option_name'])){!! $value['option_name'] !!}@endif</td>
                                                <td nowrap="nowrap">
                                                    <a href="javascript:void(0)" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-theme="dark" data-html="true" title="Edit" data-toggle="modal" data-target="#advertisementEdit_{{$key}}"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24"></rect>
                                                    ...
                                                    <div class="modal fade" id="advertisementEdit_{{$key}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form" method="POST" action="{{route('client.advertisementOptionUpdate')}}">
                                                                        @csrf
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div>
                                                                                        <input type="text" class="form-control form-control-lg  mb-2" name="option_name" value="@if(isset($value['option_name']) && !empty($value['option_name'])){!! $value['option_name'] !!}@endif" placeholder="Option Name" />
                                                    ...
                                                    <form action="{{ route('client.advertisementOptionDelete')}}" method="post" >
    ...
    <div class="modal fade" id="advertisementAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{route('client.advertisementOptionCreate')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Option Name</label>
                                    <div>
                                        <input type="text" class="form-control form-control-lg mb-2" name="option_name" value="{!! old('option_name') !!}" placeholder="Option Name" required/>
                                        <input type="hidden" name="client_id" value="{!! $u_id !!}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
