...
@section('title', 'Sub Main Client List')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Sub Main Client List
                            </h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="{{route('client.clientAdd')}}" class="btn btn-primary font-weight-bolder mr-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td nowrap="nowrap">
                                                    ...
                                                    <a href="{{route('client.clientEdit',['id' => $value['id']])}}" class="btn btn-sm btn-light btn-hover-primary btn-icon mr-2" data-toggle="tooltip" data-theme="dark" data-html="true" title="Edit"> 
                                                        <span class="svg-icon svg-icon-md"> 
                                                    ...
                                                    <form action="{{ route('client.clientDelete')}}" method="post" >
...
@section('footerScripts')
    ...
    <script>
        ...
        $('body').on('click', '.click-stars-slider', function () {
            ...
            $.ajax({
                url: "{{route('client.subClientStatusUpdate')}}",
                dataType: 'json',
                type: 'post',
                data: {
                    id: id,
