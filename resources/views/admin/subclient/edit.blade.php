...
@section('title', 'Sub Main Client Edit')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="email" id="email" value="@if(isset($user_data->email) && !empty($user_data->email)){!! $user_data->email !!}@endif" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required />
                                                        <span id="text"></span>
                                                    </div>
                                                </div>
                                            </div>
