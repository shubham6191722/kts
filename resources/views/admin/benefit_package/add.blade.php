...
@section('title', 'Add Benefits Workflows')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Add Benefits Workflows</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="{{route('client.benefitPackageList')}}" class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="card-body">
                        <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form class="form" id="kt_form_2" method="POST" action="{{ route('client.benefitPackageSave')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <div>
                                                        <input type="text" class="form-control form-control-lg custom-form-control-lg mb-2" name="title" value="{!! old('title') !!}" placeholder="Title" required />
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Benefits Workflows detail</label>
                                                    <div>
                                                        <textarea type="text" class="form-control" placeholder="Benefits Workflows detail" name="description" required>{!! old('description') !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
