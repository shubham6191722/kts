...
@section('content')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Site Address List</h3>
                        </div>
                        <div class="card-toolbar">
                            <a href="javascript:void(0)" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#siteaddressAdd">
                                    ...
                                    <table class="table dt-table-hover" id="zero-config" role="grid"
                                        ...
                                        <tbody>
                                            @if(!empty($site_address_data))
                                                @foreach($site_address_data as $key => $value)
                                                    <tr class="odd">
                                                        <td class="dtr-control" tabindex="{!!$key+1!!}">{!!$key+1!!}</td>
                                                        <td>@if(isset($value['site_title']) && !empty($value['site_title'])){!! $value['site_title'] !!}@endif</td>
                                                        <td>
                                                            @php
                                                                $address = '';
                                                                if(isset($value['site_address']) && !empty($value['site_address'])){
                                                                    $str     = $value['site_address'];
                                                                    $order   = array("\r\n", "\n", "\r");
                                                                    $replace = '<br/>';
                                                        ...
                                                        <td nowrap="nowrap">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form class="form" method="POST" action="{{route('client.siteAddressUpdate')}}">
                                                                                @csrf
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input type="text" class="form-control form-control-lg mb-2" name="site_title" placeholder="Site Title" value="@if(isset($value['site_title']) && !empty($value['site_title'])){!! $value['site_title'] !!}@endif" required/>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <textarea type="text" class="form-control" placeholder="Site Address" name="site_address" required>@if(isset($value['site_address']) && !empty($value['site_address'])){!! $value['site_address'] !!}@endif</textarea>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            <a href="javascript:;" class="btn btn-sm btn-light btn-hover-primary btn-icon delete_this" title="Delete" data-id="{!!$value['id']!!}"> 
                                                                <span class="svg-icon svg-icon-md"> 
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect x="0" y="0" width="24" height="24"></rect>
                                                            ...
                                                            <form action="{{ route('client.jobWorkFlowDelete')}}" method="post" >
    ...
    <div class="modal fade" id="siteaddressAdd" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{route('client.siteAddressCreate')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Site Title</label>
                                    <div>
                                        <input type="text" class="form-control form-control-lg mb-2" name="site_title" value="{!! old('site_title') !!}" placeholder="Site Title" required/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Site Address</label>
                                    <div>
                                        <textarea type="text" class="form-control" placeholder="Site Address" name="site_address" required>{!! old('site_address') !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
