(function ($) {
    ...
    function mainMap() {
        ...
        var locations = [
            [locationData('job-detail-1.html', 'assets/img/com-2.jpg', 'company-detail.html', '02 Web Designer', 'Job Info', '$2000 - $3500', '302 Blue Market, CA', 'full-time', 'Full Time', '#'), 40.72956781, -73.99726866, 0, markerIcon],
        ];
